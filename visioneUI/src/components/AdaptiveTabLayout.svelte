...
{#if $tabsPosition === 'top'}
  ...
  <div class="flex flex-col h-full">
    <div class="relative">
      ...
      {#if showPositionMenu}
        <div class="absolute top-12 left-2 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-50 position-menu-container">
...
{:else if $tabsPosition === 'left'}
  ...
  <div class="flex h-full">
    <div class="w-10 bg-gradient-to-b from-gray-100 to-gray-200 border-r border-gray-300 flex flex-col items-center py-4 space-y-2 shadow-sm">
      ...
      {#if showViewModeRadios}
        <div class="relative sort-dropdown-container">
          <button
            ...
            class="p-1.5 rounded-lg bg-white border border-gray-300 hover:border-blue-400 shadow-sm transition-all"
            title="Sort by"
          >
            <svg class="w-4 h-4 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <!-- Sidebar toggle -->
      <button
        class="p-1.5 rounded-lg transition-all border shadow-sm
               {isSidebarOpen 
...
{:else}
  ...
  <div class="flex h-full">
    ...
    <div class="w-16 bg-gradient-to-b from-gray-100 to-gray-200 border-l border-gray-300 flex flex-col items-center py-4 space-y-2 shadow-sm">
      <button 
        class="p-1.5 hover:bg-white/80 rounded-md transition-all position-menu-container"
        on:click|stopPropagation={() => showPositionMenu = !showPositionMenu}
        aria-label="Change tabs position"

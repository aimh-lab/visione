<script>
  ...
  function configureSearchMetadataFromDiscovery(data, profile = runtimeProfile) {
    const config = computeSearchMetadataConfig(data, profile, activeCollectionName);
    ...
    visioneAPI.knownMetadataFields = config.knownMetadataFields;
    visioneAPI.itemIdField = config.itemIdField;

...
export function createSearchController({
  ...
  function hasQueryFilterShortcuts(rawValue) {
    ...
    return /(^|\s)(date|type|semantic|sem|semantic_name|new_semantic_name|ns|y|year|m|month|d|day|h|hour|hl|hour_local|tz|timezone|country|location|location_country|hr|heart_rate_bpm):/i.test(value);
  }

...
export function createSearchController({
  ...
  function hasQueryFilterShortcuts(rawValue) {
    ...
    return /(^|\s)(date|type|semantic|sem|semantic_name|new_semantic_name|ns|y|year|m|month|d|day|h|hour|tz|timezone|country|location|location_country|music|hr|heart_rate_bpm|epoch|epoch_from|epoch_to|ef|et):/i.test(value);
  }

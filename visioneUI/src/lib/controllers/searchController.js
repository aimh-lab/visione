...
export function createSearchController({
  ...
  function hasQueryFilterShortcuts(rawValue) {
    ...
    return /(^|\s)(date|type|semantic|sem|semantic_name|new_semantic_name|ns|y|year|m|month|d|day|h|hour|tz|timezone|country|location|location_country|music|hr|heart_rate_bpm|epoch|epoch_from|epoch_to|ef|et|video_id|vid|item_time|start_time_seconds):/i.test(value);
  }

...
function selectImg(selectedItem) {		
	...
	img += '<div style="float: left; padding: 2px;">'
			...
			+'<a style="font-size:12px; padding-left: 5px;" title="View annotations of ' + selectedItem.imgId  + '" href="indexedData.html?collection=' + selectedItem.collection + '&videoId=' + selectedItem.videoId + '&id='+ selectedItem.imgId+ '" target="_blank">'+ id+'</a>'

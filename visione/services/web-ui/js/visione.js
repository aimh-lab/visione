...
const imgResult = (res, borderColor, img_loading="eager") => {
		...
		<div id="box_${res.imgId}" class="result-border" style="border-color: ${borderColor};">
			...
			<div  id="toolbar_icons_${res.imgId}">
				<a class="font-normal" title="View annotations of ${res.frameName},  Score: ${res.score}" href="indexedData.html?videoId=${res.videoId}&id=${res.imgId}" target="_blank"> ${lscId}</a>
				...
				<a href="#" title="Play Video"><i title="Play Video" class="fa fa-play font-large" style="color:#007bff;padding-left: 2px;" onclick="playVideoWindow('${res.videoUrl}', '${res.videoId}', '${res.imgId}'); return false;"></i></a>
				<!--<a href="#" title="Play Video"><i title="Play Video" class="fa fa-solid fa-video font-large" style="color:red;padding-left: 2px;" onclick="playVideoWindow('${res.videoUrl}', '${res.videoId}', '${res.imgId}'); return false;"></i></a>-->
